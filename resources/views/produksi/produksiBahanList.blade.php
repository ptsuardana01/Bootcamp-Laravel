    ...
    <tbody>
        @foreach ($komposisi_produk as $key => $row)
            @php
                ...
                $total_tersedia = \App\Models\mStokBahan::where([
                    'id_bahan' => $row->id_bahan,
                ])->sum('qty');
                $gudang = \App\Models\mStokBahan::leftJoin('tb_lokasi', 'tb_lokasi.id', '=', 'tb_stok_bahan.id_lokasi')
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text"
                                            ...
                                            value="{{ $qty_bahan }}" class="form-control touchspin-number-decimal-js"
                                            max="{{ $qty_diperlukan }}" min="0">
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
