...
<body data-csrf-token="{{ csrf_token() }}" data-produksi-bahan-list="{{ route('produksiBahanList') }}"
                                    ...
                                    <li class="m-nav__item m-topbar__user-profile m-topbar__user-profile--img  m-dropdown m-dropdown--medium m-dropdown--arrow m-dropdown--header-bg-fill m-dropdown--align-right m-dropdown--mobile-full-width m-dropdown--skin-light"
                                        ...
                                        <a href="#" class="m-nav__link m-dropdown__toggle">
                                            <span class="m-topbar__userpic">
                                                <img src="{{ asset('') }}/app/media/img/users/user4.jpg"
                                        ...
                                        <div class="m-dropdown__wrapper">
                                            ...
                                            <div class="m-dropdown__inner">
                                                <div class="m-dropdown__header m--align-center"
                                                    style="background: url({{ asset('') }}/app/media/img/misc/user_profile_bg.jpg); background-size: cover;">
                ...
                <div id="m_ver_menu" class="m-aside-menu  m-aside-menu--skin-dark m-aside-menu--submenu-skin-dark "
                    ...
                    <ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
                        <li class="m-menu__item " aria-haspopup="true">
                            <a href="{{ route('produksi') }}" class="m-menu__link ">
    ...
    {{-- <script src="{{ asset('') }}/demo/default/custom/components/datatables/base/data-local.js"
